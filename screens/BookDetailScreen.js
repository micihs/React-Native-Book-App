...
import { View, Image, Alert, StatusBar, Pressable, StyleSheet } from 'react-native';
import Animated, { interpolate, withTiming, runOnJS, useAnimatedGestureHandler, useAnimatedStyle, useSharedValue, useAnimatedScrollHandler } from 'react-native-reanimated';
...
import { useBookState } from "../database/index";
...
const getIcon = (stat) => {
    switch (stat) {
        case "Reading": return "rocket1";
        case "Completed": return "Trophy";
        case "Wishlist": return "book";
        default: return "plus";
    }
};
...
function BookDetailScreen({ navigation, route }) {
    ...
    ///this functions as the networking inteface
    useEffect(() => {
            // Related Books
